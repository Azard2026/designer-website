...
(1, 'admin@kelebekdesigners.com', '$2b$12$7kP.Lz39/4ZzV5X.fU.LHe.x7k26b1E83.0B7e930/1u/Q0K9Z2lW', 'Kelebek Admin', '+91 98765 43210', 1, true),
(2, 'sarah.designer@kelebekdesigners.com', '$2b$12$7kP.Lz39/4ZzV5X.fU.LHe.x7k26b1E83.0B7e930/1u/Q0K9Z2lW', 'Sarah Jenkins', '+91 98765 43211', 2, true),
(3, 'robert.client@gmail.com', '$2b$12$7kP.Lz39/4ZzV5X.fU.LHe.x7k26b1E83.0B7e930/1u/Q0K9Z2lW', 'Robert Miller', '+91 98765 43212', 3, true)
ON CONFLICT (id) DO NOTHING;
...
(1, 1, CURRENT_TIMESTAMP + INTERVAL '1 hour', 'Call', 'Call Ananya to introduce design concepts and schedule site visit.', false),
(2, 3, CURRENT_TIMESTAMP - INTERVAL '1 day', 'Email', 'Send follow-up portfolio images of modular kitchens.', false),
(3, 2, CURRENT_TIMESTAMP + INTERVAL '2 days', 'Meeting', 'Onsite office layout measurement and 3D review.', false)
ON CONFLICT (id) DO NOTHING;

SELECT setval('followups_id_seq', (SELECT MAX(id) FROM followups));
...
(1, 'Rajesh & Meera Kapoor', 'Villa Owners, Mumbai', 'Kelebek Designers completely redefined how we live. The lighting, choice of materials, and space flow are works of art.', 5, '/images/hero_interior_1784468037551.png', true),
(2, 'Vikram Malhotra', 'CEO, InovaTech India', 'They delivered our corporate headquarters on time and within budget. The aesthetic matches our brand perfectly.', 5, '/images/portfolio_commercial_1784468061607.png', true),
(3, 'Emily Watson', 'Penthouse Owner, Bengaluru', 'Attentions to detail is incomparable. From initial 3D renders to final styling, Kelebek was exceptional.', 5, '/images/portfolio_penthouse_1784468094816.png', false)
ON CONFLICT (id) DO NOTHING;
